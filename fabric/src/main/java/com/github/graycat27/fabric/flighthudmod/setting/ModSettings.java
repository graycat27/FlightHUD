package com.github.graycat27.fabric.flighthudmod.setting;

import com.github.graycat27.fabric.flighthudmod.FlightHUDMod;
import com.github.graycat27.fabric.flighthudmod.consts.ConfigFile;
...
public class ModSettings {
    ...
    private File getConfigFile(){
        String configDir = MinecraftClient.getInstance().runDirectory.getAbsolutePath() + ConfigFile.configDirName;
