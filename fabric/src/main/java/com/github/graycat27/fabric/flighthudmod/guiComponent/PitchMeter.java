...
import static com.github.graycat27.fabric.flighthudmod.consts.GuiTextFormat.pitchStr;
import static com.github.graycat27.fabric.flighthudmod.consts.GuiTextFormat.pitchStrDecimal;
...
public class PitchMeter extends GuiComponent {
    ...
    private void initDisplayComponent(){
        ...
        //center display
        int pitchWidth = mc.textRenderer.getWidth(String.format(Line.angleText, getDgrStringDecimal1(Pitch.UP)));
        int markWidth = mc.textRenderer.getWidth(Line.mark);
        ...
        if(pitch != null){
            ...
            for(int dgr = maxDgr; dgr >= minDgr; dgr -= interval){
                if(bottomPitch < dgr && dgr < topPitch){
                    ...
                    int width = mc.textRenderer.getWidth(angleText);
        ...
        if(speed != null){
            ...
            int width = mc.textRenderer.getWidth(flightPitchText);
